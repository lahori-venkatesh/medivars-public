...
export function BookingModal({ doctor, onClose, onBook }: BookingModalProps) {
  ...
  const renderConsultationTypes = () => (
    <div className="space-y-6">
      <h2 className="text-2xl font-semibold mb-8">Select Consultation Type</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <p className="mt-2 text-sm text-green-600">10% off regular fee</p>
        </button>
        ...
        >
          ...
          <h3 className="font-semibold mb-2">Audio Consultation</h3>
          <p className="text-sm text-gray-600 dark:text-gray-300">
            Voice-only consultation for privacy and convenience
          </p>
          <p className="mt-2 text-sm text-green-600">15% off regular fee</p>
        </button>
        ...
        >
          ...
          <p className="mt-2 text-sm text-green-600">20% off regular fee</p>
        </button>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full p-6 relative">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">Book Appointment</h2>
          ...
          <>
            ...
            <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <div className="flex items-center mb-4">
                ...
                <h4 className="font-medium">Insurance Details (Optional)</h4>
              </div>
